...
public class Transaction {
    ...
    public int getLocationMismatch() {
        return locationMismatch;
    }

    public void setLocationMismatch(int locationMismatch) {
    ...
    public double getVelocityLast24h() {
        return velocityLast24h;
    }

    public void setVelocityLast24h(double velocityLast24h) {
